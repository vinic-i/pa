        ...
        if (fin.good())
        {
            ...
            if (ss.good())
            {
                ...
                else if (token.compare("putbox") == 0)
                {
                    ...
                    std::cout << x0 << ", " << y0 << ", " << z0 << ", " << x1 << ", " << y1 << ", " << z1 << ", " << dimx << ", " << dimy << ", " << dimz << ", " << r << ", " << g << ", " << b << ", " << a << ", " << std::endl;
                ...
                else if (token.compare("putsphere") == 0)
                {
                    ...
                    std::cout << xcenter << ", " << ycenter << ", " << zcenter << ", " << radius << ", " << dimx << ", " << dimy << ", " << dimz << ", " << r << ", " << g << ", " << b << ", " << a << ", " << std::endl;
                ...
                else if (token.compare("putellipsoid") == 0)
                {
                    ...
                    std::cout << xcenter << ", " << ycenter << ", " << zcenter << ", " << rx << ", " << ry << ", " << rz << ", " << dimx << ", " << dimy << ", " << dimz << ", " << r << ", " << g << ", " << b << ", " << a << ", " << std::endl;
